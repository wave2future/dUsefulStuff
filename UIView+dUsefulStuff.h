 ...
 * \param borderColor the colour to make the border. If this is the clear colour, then no border is drawn.
 * \param fillColor the colour to fill the rectangle with. If this is clear then the rectangle is not filled.
 */
