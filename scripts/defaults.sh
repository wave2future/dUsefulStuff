...
DC_PROJECTS_HOME=${DC_PROJECTS_HOME=/Users/$USER/projects}
...
DC_LIB_PREFIX=${DC_LIB_PREFIX=lib}
...
DC_APPLEDOC_DIR=${DC_APPLEDOC_DIR=$DC_TOOLS_DIR/tools/appledoc}
