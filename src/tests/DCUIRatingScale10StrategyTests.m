...
@interface DCUIRatingScale10StrategyTests : GHTestCase {
	
}
@end

@implementation DCUIRatingScale10StrategyTests
...
-(void) testCalcNewRatingFromTouchX {
	...
	DCUIRatingScale10Strategy * strategy = [[DCUIRatingScale10Strategy alloc]initWithOffImage:mockOffImage onImage:nil halfOnImage:nil];
...
-(void) testFormattedRating0 {
	DCUIRatingScale10Strategy * strategy = [[DCUIRatingScale10Strategy alloc]initWithOffImage:nil onImage:nil halfOnImage:nil];
	strategy.rating = 0;
