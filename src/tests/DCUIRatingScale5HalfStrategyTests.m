...
@interface DCUIRatingScale5HalfStrategyTests : GHTestCase {
	
}
@end

@implementation DCUIRatingScale5HalfStrategyTests
...
-(void) testCalcNewRatingFromTouchX {
	...
	DCUIRatingScale5HalfStrategy * strategy = [[DCUIRatingScale5HalfStrategy alloc]initWithOffImage:mockOffImage onImage:nil halfOnImage:nil];
...
-(void) testFormattedRating0 {
	DCUIRatingScale5HalfStrategy * strategy = [[DCUIRatingScale5HalfStrategy alloc]initWithOffImage:nil onImage:nil halfOnImage:nil];
	strategy.rating = 0;
